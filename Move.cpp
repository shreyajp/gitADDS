...
bool Rock::defeats(const Move& o)   const { return isScissor(o) || isZombie(o); }
bool Paper::defeats(const Move& o)  const { return isRock(o)    || isRobot(o); }
bool Scissor::defeats(const Move& o)const { return isPaper(o)   || isMonkey(o); }
bool Monkey::defeats(const Move& o) const { return isRobot(o)   || isNinja(o); }
bool Robot::defeats(const Move& o)  const { return isPirate(o)  || isZombie(o); }
bool Pirate::defeats(const Move& o) const { return isNinja(o)   || isMonkey(o); }
bool Ninja::defeats(const Move& o)  const { return isZombie(o)  || isPirate(o); }
bool Zombie::defeats(const Move& o) const { return isMonkey(o)  || isPaper(o); }
